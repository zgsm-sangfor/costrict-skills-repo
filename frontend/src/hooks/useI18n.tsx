...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'about.description': { en: 'Coding Hub aggregates 4000+ curated MCP Servers, Skills, Rules, and Prompts from 9 upstream sources, updated weekly via CI. Developed by the Costrict team.', zh: 'Coding Hub 聚合了来自 9 个上游源的 4000+ 精选 MCP 服务、技能、规则和提示词，每周通过 CI 自动更新。由 Costrict 团队开发。' },
