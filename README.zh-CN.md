...
<p><strong><!-- README_APPROX_COUNT:START -->12900<!-- README_APPROX_COUNT:END -->+ 精选 AI 编程资源 — 浏览、评估、安装</strong><br/>MCP Servers · Skills · Rules · Prompts · Plugins</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/resources-12996-2ECC71?style=flat-square" alt="Resources" />
</p>
...
### [🔌 MCP 服务器](./catalog/mcp/) — <!-- README_COUNT_MCP:START -->9366<!-- README_COUNT_MCP:END --> 个条目
...
### [🧩 Plugins 插件](./catalog/plugins/) — <!-- README_COUNT_PLUGIN:START -->871<!-- README_COUNT_PLUGIN:END --> 个条目
