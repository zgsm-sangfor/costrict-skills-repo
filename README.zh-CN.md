...
<p><strong><!-- README_APPROX_COUNT:START -->13500<!-- README_APPROX_COUNT:END -->+ 精选 AI 编程资源 — 浏览、评估、安装</strong><br/>MCP Servers · Skills · Rules · Prompts · Plugins</p>
...
### [🔌 MCP 服务器](./catalog/mcp/) — <!-- README_COUNT_MCP:START -->10055<!-- README_COUNT_MCP:END --> 个条目
...
### [🧩 Plugins 插件](./catalog/plugins/) — <!-- README_COUNT_PLUGIN:START -->939<!-- README_COUNT_PLUGIN:END --> 个条目
