...
<p><strong><!-- README_APPROX_COUNT:START -->13000<!-- README_APPROX_COUNT:END -->+ 精选 AI 编程资源 — 浏览、评估、安装</strong><br/>MCP Servers · Skills · Rules · Prompts · Plugins</p>
...
<p>
  ...
  <img src="https://img.shields.io/badge/resources-13034-2ECC71?style=flat-square" alt="Resources" />
</p>
...
### [🔌 MCP 服务器](./catalog/mcp/) — <!-- README_COUNT_MCP:START -->9367<!-- README_COUNT_MCP:END --> 个条目
...
| 名称 | ⭐ Stars | 评分 | 描述 |
|------|----------|------|------|
| [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) | 32.4k | 98 | 微软官方 MCP 服务器，通过 Playwright 让 AI 精确控制浏览器进行网页自动化和数据抓取。 |
| [github/github-mcp-server](https://github.com/github/github-mcp-server) | 29.7k | 98 | GitHub 官方 MCP 服务器，让 AI 工具通过 API 深度集成 GitHub，实现仓库管理、Issue/PR 自动化和 CI/C… |
| [googleapis/genai-toolbox](https://github.com/googleapis/genai-toolbox) | 15.2k | 98 | Google官方MCP服务器，将AI代理和IDE连接到企业数据库，提供预构建工具和自定义框架。 |
...
### [🎯 Skills 技能](./catalog/skills/) — <!-- README_COUNT_SKILL:START -->1803<!-- README_COUNT_SKILL:END --> 个条目
...
### [📋 Rules 规则](./catalog/rules/) — <!-- README_COUNT_RULE:START -->373<!-- README_COUNT_RULE:END --> 个条目
...
### [💡 Prompts 提示词](./catalog/prompts/) — <!-- README_COUNT_PROMPT:START -->583<!-- README_COUNT_PROMPT:END --> 个条目
...
### [🧩 Plugins 插件](./catalog/plugins/) — <!-- README_COUNT_PLUGIN:START -->908<!-- README_COUNT_PLUGIN:END --> 个条目
