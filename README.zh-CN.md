...
<p><strong><!-- README_APPROX_COUNT:START -->13400<!-- README_APPROX_COUNT:END -->+ 精选 AI 编程资源 — 浏览、评估、安装</strong><br/>MCP Servers · Skills · Rules · Prompts · Plugins</p>
...
### [🔌 MCP 服务器](./catalog/mcp/) — <!-- README_COUNT_MCP:START -->9932<!-- README_COUNT_MCP:END --> 个条目
...
| [github/github-mcp-server](https://github.com/github/github-mcp-server) | 29.9k | 98 | GitHub 官方 MCP 服务器，让 AI 工具通过 API 深度集成 GitHub，实现仓库管理、Issue/PR 自动化和 CI/C… |
...
### [💡 Prompts 提示词](./catalog/prompts/) — <!-- README_COUNT_PROMPT:START -->598<!-- README_COUNT_PROMPT:END --> 个条目
...
### [🧩 Plugins 插件](./catalog/plugins/) — <!-- README_COUNT_PLUGIN:START -->937<!-- README_COUNT_PLUGIN:END --> 个条目
