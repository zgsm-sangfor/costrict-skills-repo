...
Footer: suggest using `/eac-browse <category>` for details; for verified recommendations, use `/eac-search` or `/eac-recommend`
...
Footer: suggest `/eac-install <id>` to install; for verified recommendations, use `/eac-search` or `/eac-recommend`
