...
class PluginContentFetcher:
    ...
    def detect_plugin_layout(
        ...
        for path in tree_paths:
            ...
            # Shadow-directory exclusion: any segment (besides the filename)
            # that starts with "." is a platform-specific artifact.
            ...
            elif path.endswith(".md") and "agents" in segments:
                agent_paths.append(path)
            elif path.endswith(".md") and "commands" in segments:
